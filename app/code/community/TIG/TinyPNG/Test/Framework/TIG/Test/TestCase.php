 ...
 */
class TIG_TinyPNG_Test_Framework_TIG_Test_TestCase extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function resetMagento()
    {
        ...
        Mage::app(
            'admin',
                'store',
                array(
                    'config_model' => 'TIG_TinyPNG_Test_Framework_TIG_Test_Config'
                )
        )->setResponse(new TIG_TinyPNG_Test_Framework_TIG_Test_Http_Response());
